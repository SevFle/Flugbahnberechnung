...
namespace nsmp_frm_object_tracking
  ...
  public ref class c_frm_Object_Tracking : public System::Windows::Forms::Form
    ...
    private:
    System::Windows::Forms::PictureBox^ pb_cam_left;
    private:
    System::Windows::Forms::PictureBox^ pb_cam_right;


    private:
    System::Windows::Forms::GroupBox^ groupBox1;
    private:
    System::Windows::Forms::Label^ lbl_cam_right;
    private:
    System::Windows::Forms::Label^ lbl_cam_left;
    private:
    ...
    private:
    System::Windows::Forms::TextBox^ txb_object_pos_z;

    private:
    System::Windows::Forms::TextBox^ txb_object_pos_y;

    private:
    System::Windows::Forms::TextBox^ txb_object_pos_x;
    ...
    private:
    System::Windows::Forms::Label^ lbl_thread_running;
