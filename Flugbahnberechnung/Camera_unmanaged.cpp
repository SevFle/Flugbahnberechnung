    ...
    switch (statemachine_state)
      {
        case 0:
          ...
          for (int i = 0; i< cameras_in_use; i++)
            {
            create_cam_vector(i);
            camera_vector[i]->create_videocapture_vector(i);
            camera_vector[i]->init(i);
        ...
        case 1:
          std::cout<< "State 1 \n\n";
          camera_vector[camera_id]->cpu_grab_frame(camera_vector[camera_id]->cpu_src_img);
        ...
        case 2:
          ...
          camera_vector[camera_id]->apply_filter(camera_vector[camera_id]->cpu_src_img, camera_vector[camera_id]->cpu_mid_img);
        ...
        case 3:
          std::cout<< "State 3 \n\n";
          camera_vector[camera_id]->cpu_mask_img(camera_vector[camera_id]->cpu_mid_img, camera_vector[camera_id]->cpu_masked_img);
          statemachine_state = 4;


        case 4:
          std::cout<< "State 4 \n\n";
          camera_vector[camera_id]->cpu_img_show(camera_vector[camera_id]->cpu_masked_img, camera_vector[camera_id]->cpu_src_img);
          if (cv::waitKey(5)>=0)
            break;
