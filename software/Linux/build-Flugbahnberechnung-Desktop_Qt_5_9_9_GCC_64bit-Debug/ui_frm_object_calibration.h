...
public:
    ...
    void setupUi(QMainWindow *C_frm_object_calibration)
    {
        ...
        num_erode_iterations->setObjectName(QStringLiteral("num_erode_iterations"));
        ...
        num_dilate_iterations->setObjectName(QStringLiteral("num_dilate_iterations"));
        ...
        num_morph_iterations->setObjectName(QStringLiteral("num_morph_iterations"));
        ...
        num_gaussian_kernelsize->setObjectName(QStringLiteral("num_gaussian_kernelsize"));
        ...
        chkb_erode->setObjectName(QStringLiteral("chkb_erode"));
        ...
        chkb_dilate->setObjectName(QStringLiteral("chkb_dilate"));
        ...
        chkb_morph->setObjectName(QStringLiteral("chkb_morph"));
        ...
        chkb_bilateral->setObjectName(QStringLiteral("chkb_bilateral"));
    ...
    void retranslateUi(QMainWindow *C_frm_object_calibration)
    {
        ...
        bt_apply_all->setText(QApplication::translate("C_frm_object_calibration", "Apply all", Q_NULLPTR));
        bt_apply->setText(QApplication::translate("C_frm_object_calibration", "Apply", Q_NULLPTR));
        bt_tracking->setText(QApplication::translate("C_frm_object_calibration", "Tracking", Q_NULLPTR));
    } // retranslateUi
