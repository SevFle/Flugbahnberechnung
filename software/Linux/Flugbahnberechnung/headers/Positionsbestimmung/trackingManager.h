...
namespace trackingManager
  ...
  class C_trackingManager
    ...
    void predictKalman                                ();
    S_Positionsvektor iteratekf                           (posen::S_Positionsvektor& predBall_in, posen::S_Positionsvektor& predBall_out, double& timeOnTarget_in, double& timeOnTarget_out, double& timeOnTarget_mid);
    bool getAlive                                     () const;
    ...
    bool inConstraint                                 (posen::S_Positionsvektor b);
    };
  }
#endif
