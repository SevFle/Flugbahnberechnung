...
namespace Camera
  ...
  public:
    ...
    public:
      S_filterProperties();
      ~S_filterProperties();
      int getHue_min() const;
      void setHue_min(const int &value);
      int getHue_max() const;
      void setHue_max(const int &value);
      int getSaturation_min() const;
      void setSaturation_min(const int &value);
      int getSaturation_max() const;
      void setSaturation_max(const int &value);
      int getValue_min() const;
      void setValue_min(const int &value);
      int getValue_max() const;
      void setValue_max(const int &value);
