...
namespace NmSp_CamerCalibration_Single
  ...
  public ref class C_frm_CameraCalibration_Single : public System::Windows::Forms::Form
    ...
    private:
    System::Windows::Forms::PictureBox^ pb_live_camera_picture;

    private:
    System::Windows::Forms::Label^ label1;
    private:
    System::Windows::Forms::PictureBox^ pb_taken_picture_1;
    private:
    System::Windows::Forms::PictureBox^ pb_taken_picture_2;
    private:
    System::Windows::Forms::PictureBox^ pb_taken_picture_3;


    private:
    System::Windows::Forms::TextBox^ tb_picture_count;
    private:
    System::Windows::Forms::Label^ label2;
    private:
    System::Windows::Forms::Button^ bt_start;
    private:
    System::Windows::Forms::Label^ label3;
    private:
    System::Windows::Forms::TextBox^ tb_single_imgs_to_take;

    private:
    System::Windows::Forms::Label^ label4;
    private:
    System::Windows::Forms::TextBox^ tb_single_edge_length;

    private:
    System::Windows::Forms::Label^ label5;
    private:
    System::Windows::Forms::TextBox^ tb_single_corner_count_B;

    private:
    System::Windows::Forms::TextBox^ tb_single_corner_count_H;
    private:
    System::Windows::Forms::GroupBox^ grB_options;


    private:
    System::Windows::Forms::RadioButton^ rb_single_calibration;
    private:
    System::Windows::Forms::RadioButton^ rb_stereo_calibration;


    private:
    System::Windows::Forms::GroupBox^ groupBox3;
    private:
    System::Windows::Forms::TextBox^ tb_photo_interval;
    ...
    private:
    System::Windows::Forms::Label^ lbl_calibration_running;
    private:
    System::Windows::Forms::Button^ bt_take_photo;
    private:
    System::Windows::Forms::PictureBox^ pb_stereo_L;
    private:
    System::Windows::Forms::PictureBox^ pb_stereo_R;
    private:
    System::Windows::Forms::Button^ bt_show_crop;
