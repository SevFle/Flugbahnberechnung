...
//    cv::imwrite("../Parameter/Charuco_BoardImage_5_7_0.04f_0.02f_Size(3200, 2200).jpg", boardImage);
  ...
  this->robotManager = new C_robotManager(GlobalObjects);
  ...
  this->frm_Robot_Calibration           = new C_frm_Robot_Calibration(GlobalObjects, this);
...
#include "sources/Forms/frm_main.cpp"
#include "sources/Forms/frm_object_calibration.cpp"
#include "sources/Forms/frm_object_tracking.cpp"
#include "sources/Forms/frm_camera_calibration.cpp"
#include "sources/Forms/frm_camera_positioning.cpp"
#include "sources/Forms/frm_camera_positioning_pose.cpp"
